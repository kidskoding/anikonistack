{
  ...
  spartanRules = [
    ...
    "core/TIMEZONE"
    "core/SKILL_AUTHORING"
    "database/SCHEMA"
    "database/ORM_AND_REPO"
    "database/TRANSACTIONS"
    "shared-backend/ARCHITECTURE"
    "backend-micronaut/KOTLIN"
    "backend-micronaut/CONTROLLERS"
    "backend-micronaut/SERVICES_AND_BEANS"
    "backend-micronaut/API_DESIGN"
    "backend-micronaut/RETROFIT_PLACEMENT"
    "backend-micronaut/BATCH_PROCESSING"
    "frontend-react/FRONTEND"
    "ux-design/DESIGN_PROCESS"
    "infrastructure/STRUCTURE"
    "infrastructure/MODULES"
    "infrastructure/STATE_AND_BACKEND"
...
in {
  programs.claude-code = {
    ...
    commands =
      {spartan = "${spartan}/commands/spartan.md";}
      // lib.listToAttrs (map
